					...
					<tr>
						...
						<td><?php echo $value['duration']; ?></td>
 						...
 						<td>
							...
							<a href="reserve.php?id=<?php echo $value['room_cat']; ?>&customer_id=<?php echo $value['customer_id']; ?>" class="btn btn-success"><i class="fa fa-plus"></i>
								حجز
							</a>
							<a href="delete_waiting.php?id=<?php echo $value['reserve_id']; ?>" class="btn btn-danger confirm"><i class="fa fa-close"></i>
								حذف</a>
						</td>
					</tr>
<?php $count++ ; } ?>
